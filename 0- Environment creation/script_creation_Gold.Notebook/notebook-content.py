...
# MAGIC    Chaque table est un Data Product sur un schéma distinct
# MAGIC    =========================================================== */
# MAGIC 
# MAGIC /* ---------- Création des schémas ---------- */
# MAGIC CREATE SCHEMA IF NOT EXISTS dp1;
# MAGIC CREATE SCHEMA IF NOT EXISTS dp2;
# MAGIC CREATE SCHEMA IF NOT EXISTS dp3;
# MAGIC CREATE SCHEMA IF NOT EXISTS dp4;
# MAGIC CREATE SCHEMA IF NOT EXISTS dp5;
# MAGIC CREATE SCHEMA IF NOT EXISTS dp6;
# MAGIC CREATE SCHEMA IF NOT EXISTS dp7;
# MAGIC CREATE SCHEMA IF NOT EXISTS dp8;
# MAGIC CREATE SCHEMA IF NOT EXISTS dp9;
...
# MAGIC %%sql
# MAGIC /* ---------- dp1.dp_brc_global ---------- */
# MAGIC DROP TABLE IF EXISTS dp1.dp_brc_global;
# MAGIC 
# MAGIC CREATE TABLE dp1.dp_brc_global (
...
# MAGIC %%sql
# MAGIC /* ---------- dp2.dp_brc_cfiab ---------- */
# MAGIC DROP TABLE IF EXISTS dp2.dp_brc_cfiab;
# MAGIC 
# MAGIC CREATE TABLE dp2.dp_brc_cfiab (
# MAGIC     Numero_Semaine                                                  INT,
# MAGIC     Code_GPS                                                        VARCHAR(10),
# MAGIC     Identifiant_technique_tache                                     INT,
...
# MAGIC %%sql
# MAGIC /* ---------- dp3.dp_brc_dsn ---------- */
# MAGIC DROP TABLE IF EXISTS dp3.dp_brc_dsn;
# MAGIC 
# MAGIC CREATE TABLE dp3.dp_brc_dsn (
# MAGIC     Numero_Semaine                                                              INT,
# MAGIC     Code_GPS                                                                    VARCHAR(10),
# MAGIC     Identifiant_technique_tache                                                 INT,
# MAGIC     Identifiant_fonctionnel_IRC_Tache                                           VARCHAR(55),
...
# MAGIC %%sql
# MAGIC /* ---------- dp4.dp_scl_tache ---------- */
# MAGIC DROP TABLE IF EXISTS dp4.dp_scl_tache;
# MAGIC 
# MAGIC CREATE TABLE dp4.dp_scl_tache (
# MAGIC     Numero_Semaine                                      INT,
# MAGIC     Code_GPS                                            VARCHAR(10),
...
# MAGIC %%sql
# MAGIC /* ---------- dp5.dp_scl_dossier ---------- */
# MAGIC DROP TABLE IF EXISTS dp5.dp_scl_dossier;
# MAGIC 
# MAGIC CREATE TABLE dp5.dp_scl_dossier (
# MAGIC     Numero_Semaine                                                  INT,
# MAGIC     Code_GPS                                                        VARCHAR(10),
# MAGIC     Identifiant_du_dossier                                          VARCHAR(20),
...
# MAGIC %%sql
# MAGIC /* ---------- dp6.dp_brc_cfiab_stock_tache ---------- */
# MAGIC DROP TABLE IF EXISTS dp6.dp_brc_cfiab_stock_tache;
# MAGIC 
# MAGIC CREATE TABLE dp6.dp_brc_cfiab_stock_tache (
# MAGIC     Numero_Semaine                                      INT,
# MAGIC     Code_GPS                                            VARCHAR(10),
# MAGIC     Identifiant_technique_tache                         INT,
# MAGIC     Identifiant_fonctionnel_IRC_Tache                   VARCHAR(55),
...
# MAGIC %%sql
# MAGIC /* ---------- dp7.dp_brc_dsn_stock_tache ---------- */
# MAGIC DROP TABLE IF EXISTS dp7.dp_brc_dsn_stock_tache;
# MAGIC 
# MAGIC CREATE TABLE dp7.dp_brc_dsn_stock_tache (
# MAGIC     Numero_Semaine                                                              INT,
# MAGIC     Code_GPS                                                                    VARCHAR(10),
# MAGIC     Identifiant_technique_tache                                                 INT,
# MAGIC     Identifiant_fonctionnel_IRC_Tache                                           VARCHAR(55),
...
# MAGIC %%sql
# MAGIC /* ---------- dp8.dp_scl_dossier_stock_synthese ---------- */
# MAGIC DROP TABLE IF EXISTS dp8.dp_scl_dossier_stock_synthese;
# MAGIC 
# MAGIC CREATE TABLE dp8.dp_scl_dossier_stock_synthese (
# MAGIC     Numero_Semaine                                                  INT,
# MAGIC     Code_GPS                                                        VARCHAR(10),
# MAGIC     Identifiant_du_dossier                                          VARCHAR(20),
# MAGIC     Identifiant_individu_de_Communication                           VARCHAR(15),
...
# MAGIC %%sql
# MAGIC /* ---------- dp9.dp_brc_agrege ---------- */
# MAGIC DROP TABLE IF EXISTS dp9.dp_brc_agrege;
# MAGIC 
# MAGIC CREATE TABLE dp9.dp_brc_agrege (
# MAGIC     Numero_Semaine                                                  INT,
# MAGIC     Code_GPS                                                        VARCHAR(10),
# MAGIC     IRC_primo_affectation_tache                                     VARCHAR(55),
# MAGIC     Libelle_Chemin_Arborescence_nom_de_l_entite_de_Gestion_d_affectation VARCHAR(250),
